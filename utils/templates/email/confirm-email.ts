                ...
                <table role="presentation" cellspacing="0" cellpadding="0">
                  <tr>
                    <td bgcolor="#007bff" style="border-radius:6px; text-align:center;">
                      <a href="{{verifyUrl}}" target="_blank" style="display:inline-block; padding:14px 28px; font-size:16px; color:#ffffff; text-decoration:none; border-radius:6px;">
                        {{confirmButton}}
                      </a>
                    </td>
                  </tr>
            ...
            <tr>
              <td style="padding:0 20px;">
                ...
                <p style="word-break:break-all; font-size:14px; color:#007bff;">
                  <a href="{{verifyUrl}}" style="color:#007bff; text-decoration:none;">
                    {{verifyUrl}}
                  </a>
                </p>
              </td>
