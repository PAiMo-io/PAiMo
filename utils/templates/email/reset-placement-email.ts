          ...
          <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px; margin:0 auto; background:#ffffff; padding:30px 20px; border-radius:10px;">
            ...
            <tr>
              <td align="center" style="padding:0 20px;">
                <h2 style="color:#222; font-size:24px;">{{subTitle}}</h2>
                <p style="font-size:16px; line-height:1.6; color:#333;">{{{intro}}}</p>
              </td>
            </tr>
            <tr>
                ...
                <table role="presentation" cellspacing="0" cellpadding="0">
                  <tr>
                    <td bgcolor="#007bff" style="border-radius:6px; text-align:center;">
                      <a href="{{placementUrl}}" target="_blank" style="display:inline-block; padding:14px 28px; font-size:16px; color:#ffffff; text-decoration:none; border-radius:6px;">
                        {{startButton}}
                      </a>
                    </td>
                  </tr>
            ...
            <tr>
              <td style="padding:0 20px;">
                <p style="font-size:14px; color:#555;">{{fallbackTip}}</p>
                <p style="word-break:break-all; font-size:14px; color:#007bff;">
                  <a href="{{placementUrl}}" style="color:#007bff; text-decoration:none;">{{placementUrl}}</a>
                </p>
              </td>
            </tr>
            <tr>
